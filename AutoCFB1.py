...
try:
    ...
    print(f"{style} \033[1;32m TOOL IS NOT ALLOW WITHOUT STORAGE PERMISSION");os.system('termux-setup-storage');os.system('clear');exit(f"{style} \033[1;32mRUN AGAIN : python AUTO.py")
#▬▭▬▭▬▭▬▭[INTERNET]▬▭▬▭▬▭▬▭#
try:
...
print(f'{style} \033[1; 32MACTIVE STATUS API...\033[1;37m');time.sleep(2)
...
def fake_philippines():
    ...
    return first,last
#▬▭▬▭▬▭▬▭[AUTO PASSWORD]▬▭▬▭▬▭▬▭#
random_password1=['Qhay1240zx_','Shjambz23_','Huao*_126','Create1120z_','Ahfixoa_*','agducmaoz','#Agdurnxa','Agdbpkj_1','Wghao12','Aahmo_','Xadji_12','Auroas_1112','Crhauo1','eydhjl111&','Qweee1','Love12','Maximo15740','XIAO']
...
██║  ██║╚██████╔╝   ██║   ╚██████╔╝██║     ██████╔╝██║  ██║     ██╔╝ ██╗
╚═╝  ╚═╝ ╚═════╝    ╚═╝    ╚═════╝ ╚═╝     ╚═════╝ ╚═╝  ╚═╝     ╚═╝  ╚═╝              """" "))
info=(f"""{style} \033[1;32mAUTHOR   \033[1;37m: \033[1;32mAlexa
{style} \033[1;32mFACEBOOK \033[1;37m: \033[1;32mMCLAREM
...
#▬▭▬▭▬▭▬▭[MAIN MENU]▬▭▬▭▬▭▬▭#
def main():
    main_logo();print(f'\033[1;37m[\033[1;32mA\033[1;37m]\033[1;32m START AUTO CREATE M1-M3');print(f'\033[1;37m[\033[1;32mO\033[1;37m]\033[1;31m EXIT THIS PROGRAM');linex()
...
def confirm_id(mail,uid,otp,data,ses,random_password):
    try:
        ...
        if "checkpoint" in str(response.url):
            ...
            #print(f"\r\r\033[1;37m[\033[1;32mSUCCESS-ACCOUNT CREATE 📂\033[1;37m] \033[1;32m{uid} \033[1;31m» \033[1;32m{random_password} \033[1;31m» \033[1;32m{otp}")
            print(f"\r\r\033[1;37m[\033[1;32mSUCCESS-ACCOUNT CREATE 📂\033[1;37m] \033[1;32m{uid} \033[1;31m» \033[1;32m{random_password}")
            try:open("/sdcard/-ERROR-AUTO-CRATE-M1-COOKIE.txt","a").write(uid+"|"+random_password+"|"+otp+"|"+cookie_string+"\n");open("/sdcard/MR-ERROR-AUTO-CRATE-M1-OK.txt","a").write(uid+"|"+random_password+"\n");open("/sdcard/MR-ERROR-AUTO-CRATE-M1-EMAIL.txt","a").write(mail+"\n")
